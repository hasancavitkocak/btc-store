  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.status === 'SUCCESS') {
        setToast({ message: isEdit ? 'Yetki güncellendi' : 'Yetki eklendi', type: 'success' });
        setTimeout(() => {
    ...
    <div className="p-8">
      <div className="mb-8">
        ...
        <h1 className="text-4xl font-bold text-gray-900 mb-2">
          {isEdit ? 'Yetki Düzenle' : 'Yeni Yetki Ekle'}
        </h1>
        <p className="text-gray-600">Sistem yetkisi bilgilerini girin</p>
      </div>
              ...
              <div className="space-y-4">
                ...
                <label className="flex items-center gap-3 p-4 border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600">Bu yetki kullanılabilir olsun</div>
                  </div>
                </label>
              </div>
            </Card>
